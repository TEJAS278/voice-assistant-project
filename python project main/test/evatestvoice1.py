...
class Widget:
    def __init__(self):
       ...
       root.resizable(0, 0)
       root.iconbitmap(r'T:\python project main\main\eva1.ico')
       img = ImageTk.PhotoImage(Image.open(r"T:\project reference images\download.jpg"))
       ...
       speak('Hello TJ, I am Karen! What should I do for You?')
       self.compText.set('Hello TJ, I am Karen! What should I do for You?')
